...
class Model:
    ...
    def save(self):
        ...
        # MODIFICATION NOTE:
        # The provided template code `ds.model.save(self, "model.pickle")` throws a
        # TypeError with kumparanian v1.2.1 (missing positional arguments: 'label_encoder_object', etc.).
        # Since we use a self-contained Pipeline that handles encoding internally,
        # we revert to standard python pickle to ensure the submission artifact is generated correctly.
        try:
            with open("model.pickle", "wb") as file:
                pickle.dump(self.pipeline, file)
            print("Model saved to model.pickle (via standard pickle)")
